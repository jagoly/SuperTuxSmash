...
class Script is ScriptBase {
  ...
  execute() {
    ...
    wait_until(10)
    action.play_sound("Spin")
    action.enable_hitblob_group(3)

    wait_until(11)
    action.disable_hitblob_group(3)

    wait_until(12)
    action.enable_hitblob_group(4)

    wait_until(13)
    action.play_sound("Spin")
    action.disable_hitblob_group(4)
    ...
    action.enable_hitblob_group(5)

    wait_until(26)
    action.disable_hitblob_group(5)
