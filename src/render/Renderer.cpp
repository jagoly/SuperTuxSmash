...
//void Renderer::set_stage(unique_ptr<RenderStage>&& stage)
//{
//    mStage = std::move(stage);
//}

void Renderer::add_fighter(unique_ptr<RenderFighter>&& fighter)
{
    mFighters.push_back(std::move(fighter));
}
...
void Renderer::render(float progress)
{
